...
MPBanter1 = { 
	...
	["mpbanter1_1", nil, MP2] remoteExec ["FoxClub_fnc_Conversation", allPlayers select {_x distance MP2 <= 100}]; 
	
};

MPBanter2 = {
    
    ["mpbanter2_1", nil, MP2] remoteExec ["FoxClub_fnc_Conversation", allPlayers select {_x distance MP2 <= 100}];

};

MPBanter3 = {
    
    ["mpbanter3_1", nil, MP2] remoteExec ["FoxClub_fnc_Conversation", allPlayers select {_x distance MP2 <= 100}];
